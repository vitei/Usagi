...
namespace usg
{
	...
	namespace Particle 
	{
		...
		static const DescriptorDeclaration g_scriptedDescriptorDecl[] =
		{
			...
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_CUSTOM,		DESCRIPTOR_TYPE_CONSTANT_BUFFER,		1, SHADER_FLAG_VERTEX),
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_INSTANCE_1,	DESCRIPTOR_TYPE_CONSTANT_BUFFER,		1, SHADER_FLAG_GEOMETRY),
		...
		static const DescriptorDeclaration g_scriptedDescriptorDeclLocal[] =
		{
			...
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_MATERIAL,	DESCRIPTOR_TYPE_CONSTANT_BUFFER,			1, SHADER_FLAG_VERTEX),
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_CUSTOM,		DESCRIPTOR_TYPE_CONSTANT_BUFFER,			1, SHADER_FLAG_VERTEX),
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_INSTANCE,	DESCRIPTOR_TYPE_CONSTANT_BUFFER,			1, SHADER_FLAG_VERTEX),
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_INSTANCE_1,	DESCRIPTOR_TYPE_CONSTANT_BUFFER,			1, SHADER_FLAG_GEOMETRY),
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_MATERIAL_1,	DESCRIPTOR_TYPE_CONSTANT_BUFFER,			1, SHADER_FLAG_PIXEL),
			DESCRIPTOR_END()
		};
