...
namespace usg
{
	namespace SceneConsts
	{
		...
		{
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_GLOBAL, DESCRIPTOR_TYPE_CONSTANT_BUFFER, 1, ShaderTypeFlags(SHADER_FLAG_VERTEX| SHADER_FLAG_TEVAL| SHADER_FLAG_TCONTROL)),
			DESCRIPTOR_END()
		};
		...
		{
			DESCRIPTOR_ELEMENT(SHADER_CONSTANT_CUSTOM_2, DESCRIPTOR_TYPE_CONSTANT_BUFFER, 1, SHADER_FLAG_VERTEX),
			DESCRIPTOR_END()
		};
